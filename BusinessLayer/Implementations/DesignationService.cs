...
namespace BusinessLayer.Implementations
{
    public class DesignationService:IDesignationService
    {
        ...
        public async Task<ApiResponse<DesignationDTO>> CreateAsync(CreateUpdateDesignationDto dto, int createdBy)
        {
            try
            {
        ...
        public async Task<ApiResponse<DesignationDTO>> UpdateAsync(int id, CreateUpdateDesignationDto dto, int modifiedBy)
        {
            try
            {
        ...
        public async Task<ApiResponse<object>> SoftDeleteAsync(int id, int modifiedBy)
        {
            try
            {
                var entity = await _unitOfWork.Repository<Designation>().GetByIdAsync(id);
