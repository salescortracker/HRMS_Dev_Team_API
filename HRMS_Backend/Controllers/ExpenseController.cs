...
namespace HRMS_Backend.Controllers
{
    ...
    public class ExpenseController : ControllerBase
    {
        ...
        [HttpGet("GetForApproval/{managerId}")]
        public async Task<IActionResult> GetForApproval(int managerId)
        {
        ...
        public async Task<IActionResult> ApproveReject([FromBody] ApproveRejectExpenseDto dto)
        {
            try
            {
